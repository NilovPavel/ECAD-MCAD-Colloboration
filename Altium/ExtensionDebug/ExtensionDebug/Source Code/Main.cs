...
namespace CSharpPlugin
{
    ...
    public class PluginFactory : IPluginFactory
    {
        ...
        {
            PluginServerModule serverModule = new PluginServerModule(a, "ExtensionDebug");
            return serverModule;
        }
    }
    ...
    public class PluginServerModule : ServerModule
    {
        ...
        protected override void InitializeCommands()
        {
            ...
            ((CommandLauncher)CommandLauncher).RegisterCommand("BoardData", this.Command_BoardData, this.GetState_BoardData);
        ...
        //Autogenerated code. Begin of definition [GetState_BoardData]
        ...
        {
            new Commands().GetState_BoardData(argContext, ref argParameters, ref argEnabled, ref argChecked, ref argVisible, ref argCaption, ref argImageFile);
            return;
        }
        //Autogenerated code. End of definition [GetState_BoardData]

        //Autogenerated code. Begin of definition [Command_BoardData]
        private void Command_BoardData(IServerDocumentView argView, ref string argParameters)
        {
            new Commands().Command_BoardData(argView, ref argParameters);
            return;
        }
        //Autogenerated code. End of definition [Command_BoardData]
